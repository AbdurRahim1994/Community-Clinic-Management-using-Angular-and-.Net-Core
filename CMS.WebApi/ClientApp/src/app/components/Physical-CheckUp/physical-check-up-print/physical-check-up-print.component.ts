...
@Component({
  selector: 'app-physical-check-up-print',
  templateUrl: './physical-check-up-print.component.html',
  styleUrls: ['./physical-check-up-print.component.css']
})
export class PhysicalCheckUpPrintComponent implements OnInit {
